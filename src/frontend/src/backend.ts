...
import type { ContentBlock as _ContentBlock, GalleryItem as _GalleryItem, Notice as _Notice, StaffMember as _StaffMember, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addNotice(arg0: string, arg1: string, arg2: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async addStaffMember(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async deleteContentBlock(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteContentBlock(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllContentBlocks(): Promise<Array<[string, ContentBlock]>> {
        if (this.processError) {
            try {
    ...
    async getStaffList(): Promise<Array<StaffMember>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStaffList();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStaffMember(arg0: bigint): Promise<StaffMember | null> {
        if (this.processError) {
            try {
    ...
    async updateGalleryItem(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateNotice(arg0: bigint, arg1: string, arg2: string, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateStaffMember(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ContentBlock]): ContentBlock | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_GalleryItem]): GalleryItem | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StaffMember]): StaffMember | null {
    return value.length === 0 ? null : value[0];
}
